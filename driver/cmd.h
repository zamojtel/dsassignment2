...
#define ATDD_READ_RESPONSE_HEADER_SIZE 24
#define HMAC_TAG_SIZE 32
#define ATDD_REQUEST_HEADER_SIZE  40
#define MAX_RESPONSE_SIZE (ATDD_READ_RESPONSE_HEADER_SIZE + SECTOR_SIZE + HMAC_TAG_SIZE)
